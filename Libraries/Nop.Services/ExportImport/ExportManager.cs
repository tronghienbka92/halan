...
namespace Nop.Services.ExportImport
{
    ...
    public partial class ExportManager : IExportManager
    {
        ...
        public virtual   void ExportDSKhachHangToXlsx(Stream stream, List<KhachHang> KhachHang)
        {
            if (stream == null)
                throw new ArgumentNullException("stream");
            ...
            using (var xlPackage = new ExcelPackage(stream))
            {
                ...
                // get handle to the existing worksheet
                var worksheet = xlPackage.Workbook.Worksheets.Add("DSHanhkhach");
                //Create Headers and format them
                worksheet.DefaultRowHeight = 20;
                worksheet.Cells["A1:D1"].Merge = true;

                worksheet.Cells[1, 1].Value = "Danh sách hành khách";
                ...
                worksheet.Cells["D2"].Value = "Ngày " + DateTime.Now.ToString("dd/MM/yyyy HH:mm");
                worksheet.Cells["D2"].Style.Font.Bold = true;
                ...
                foreach (var item in KhachHang)
                {
                    ...
                    worksheet.Cells[row, col].Value = item.Ten;
                    col++;
                    ...
                    worksheet.Cells[row, col].Value = item.DiaChi;
                    col++;
